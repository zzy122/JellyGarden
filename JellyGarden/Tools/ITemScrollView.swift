...
class ITemScrollView: UIView {
    ...
    lazy var selectView:UIView = {
        let view = UIView()
        view.backgroundColor = APPCustomBtnColor
    ...
    lazy var scrollView:UIScrollView = {
        ...
        for i in 0 ..< self.titleAry.count
        {
            ...
            btn.setTitleColor(APPCustomBtnColor, for: UIControlState.selected)
    ...
    lazy var widths:[CGFloat] = {
        ...
        for str:String in self.titleAry {
            let width = str.zzy.caculateWidth(font: UIFont.systemFont(ofSize: 15))
