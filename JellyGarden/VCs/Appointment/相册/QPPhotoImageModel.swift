...
class QPPhotoImageModel: NSObject {
    ...
    func initSelf(asset: PHAsset) {
        ...
        //小图
        imageManeger.requestImage(for: asset, targetSize: CGSize.init(width: 50, height: 50), contentMode: PHImageContentMode.default, options: smallOptions, resultHandler: { (image, info) in
            if image != nil{
